...
VLLM_API_BASE = os.getenv("VLLM_API_BASE", "http://localhost:32000/v1")
TOP_K = 5
CHUNK_SIZE = 500
CHUNK_OVERLAP = 75
...
def main() -> None:
    ...
    if not os.getenv("VLLM_API_BASE") and args.command == "generate":
        print(
            "WARNING: VLLM_API_BASE is not set. "
            "Defaulting to http://localhost:32000/v1",
            file=sys.stderr,
        )
